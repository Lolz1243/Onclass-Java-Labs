package P86;
/*
8.6 (Savings Account Class) Create class SavingsAccount. Use a static variable
...
added to savings-Balance. Provide a static method modifyInterestRate that sets
...
to 4%, then calculate the monthly interest for each of 12 months and print the
new balances for both savers. Next, set the annualInterestRate to 5%,
calculate the next month’s interest and print the new balance for both savers.
 */
...
public class SavingsAccount {
	...
	{
		double monthInt = (getSavingsBalance() * annualInterestRate) / 12;
		savingsBalance = (monthInt + getSavingsBalance());
