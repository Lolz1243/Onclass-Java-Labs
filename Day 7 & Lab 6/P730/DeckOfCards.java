...
public class DeckOfCards
{
   ...
   public void checkPair()
   {
	   ...
	   if (numOfPairs >= 1)
	   {
		   System.out.printf("%nThis hand has a pair.");  
	   }
	   if (numOfPairs == 2)
	   {
		   System.out.printf("%nThis hand has two pairs.");
	   }
   }
   

   
   public void checkThreeAndFour()
   {
	   int numOfMatches;
	   for (int m = 0; m < 5; m++)
	   {
		   ...
		   if (numOfMatches == 2)
		   {
			   System.out.printf("%nThis hand has three of a kind.");
		   }
		   if (numOfMatches == 3)
		   {
			   System.out.printf("%nThis hand has four of a kind.");
		   }
	   }
   }
   ...
   public void checkFlush()
   {
	   ...
	   for (int m = 0; m < 5; m++)
	   {
		   ...
		   if (numOfMatches == 4)
		   {
			   System.out.printf("%nThis hand has a flush.");
		   }
	   }
   }
   ...
   { 
	   ...
	   if (numOfCard == 4)
		   System.out.printf("%nThis hand has a straight.");
   }
   ...
   public void checkFullHouse()
   {
	   ...
	   for (int m = 0; m < 5; m++)
	   {
		   ...
		   if (numOfPairs >= 1 && numOfMatches == 3)
			   System.out.printf("%nThis hand has a full house.");
	   }
   } 
